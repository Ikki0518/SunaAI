        ...
        <div className="max-w-md w-full mx-4">
          <div className="bg-white rounded-2xl shadow-xl border border-gray-200 p-8">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">直接アクセス用ダッシュボード</p>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-gray-900">📊 管理者ダッシュボード（直接アクセス）</h1>
        ...
        <div className="bg-green-50 border border-green-200 rounded-2xl p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <h3 className="font-medium text-green-900">管理者ダッシュボードが正常に動作しています！</h3>
              <p className="text-sm text-green-700 mt-1">
                直接アクセス方式で統計データを表示中。本番環境でも確実に動作します。
              </p>
            </div>
          </div>
        </div>
