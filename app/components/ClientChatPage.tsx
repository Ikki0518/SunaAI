              ...
              <div className="h-full flex flex-col items-center justify-center px-4 md:px-6">
                <div className="text-center mb-8">
                  ...
                  <button
                    ...
                    className="group relative inline-flex items-center justify-center px-6 md:px-8 py-3 md:py-4 font-bold text-white transition-all duration-200 ease-in-out transform bg-gradient-to-r from-blue-500 to-blue-600 rounded-xl md:rounded-2xl hover:from-blue-600 hover:to-blue-700 hover:scale-105 hover:shadow-xl"
                  >
              ...
              <div className="max-w-3xl mx-auto px-4 md:px-6 py-6 md:py-8 space-y-4 md:space-y-6">
                {messages.map((msg, idx) => (
                  <div key={`${msg.role}-${idx}`} className={`flex ${msg.role === "user" ? "justify-end" : "justify-start"}`}>
                    <div className={`max-w-[85%] md:max-w-2xl ${msg.role === "user" ? "order-2" : "order-1"}`}>
                      <div
                        className={`px-4 md:px-6 py-3 md:py-4 rounded-xl md:rounded-2xl ${
                          msg.role === "user"
                            ? "bg-blue-500 text-white"
                            : "bg-gray-100 text-gray-900"
                        }`}
                      >
                        <div className={`text-xs md:text-sm font-medium mb-1 md:mb-2 ${msg.role === "user" ? "text-blue-100" : "text-gray-600"}`}>
                ...
                {loading && (
                  <div className="flex justify-start">
                    <div className="max-w-[85%] md:max-w-2xl">
                      <div className="px-4 md:px-6 py-3 md:py-4 rounded-xl md:rounded-2xl bg-gray-100">
